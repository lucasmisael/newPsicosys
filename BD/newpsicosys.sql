...
--
-- Host: 127.0.0.1
-- Generation Time: 20-Nov-2018 às 00:54
...
(1, 'Maria Helena Nogueira Ferreira Oliveira', 0, '295.664.168-90', '1980-09-04', 'Rua Pedro Gusso', '81.050-200', 'Maria Helena', '(41) 3079-5449', 'Miguel', '(41) 98864-0013', 'Tiago', '(41) 3276-6487', 'Tiago', '(41) 98805-5870', 'lenaenf@hotmail.com', '102030405060708090', 'JPK3080', 1, 'observacaaooooooooooooooooooooooooooooooooooo', 'Crianca', 'TiagÃ£o das Meninas', '0000-00-00', 'Manha');
...
(1, 'Tiago Dantas de Oliveira', 0, 'Ginecologista', 'A', NULL, NULL, NULL, '030.471.279-56', 'COREN', '1980-09-26', 'Rua Pedro Gusso, 12 ', '81.050-200', '(41) 3276-6457', '(41) 98805-5870', 'tiago@softdib.com.br', 1, 'Ã© tudo nossoooooooooo', '(41) 3079-5449', '(41) 98864-0013');
...
INSERT INTO `tab_usuarios` (`USU_COD`, `USU_NOME`, `USU_EMAIL`, `USU_SENHA`) VALUES
(1, 'Tiago', 'tiago@softdib.com.br', 'tiago'),
(2, 'Admin', 'administrador@psicosys.com.br', '1234');
...
--
ALTER TABLE `tab_profissionais`
  MODIFY `PROF_COD` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;COMMIT;
